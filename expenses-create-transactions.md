...
The `syncBatchId` is used to track the sync status. See [Sync transactions](./expenses-sync-transactions.md) for monitoring sync progress.
...
Before creating expenses, you need valid IDs from your accounting system. See [Map transactions](./expenses-map-transactions.md) for details on retrieving account, tax rate, supplier, and customer IDs.
...
* [Sync transactions](./expenses-sync-transactions.md) - Learn how to track sync status
