...
* [Create transactions](./expenses-create-transactions.md) - Learn how to create expense transactions with proper mappings
* [Sync transactions](./expenses-sync-transactions.md) - Understand how mappings are applied during sync
