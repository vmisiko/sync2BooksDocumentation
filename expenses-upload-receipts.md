...
Attach files (receipts, invoices, documents) to synced expense transactions
...
* [Create transactions](./expenses-create-transactions.md) - Create and sync expenses
* [Sync transactions](./expenses-sync-transactions.md) - Track sync status
* [Configure customer](./expenses-configure-customer.md) - Connect accounting systems
