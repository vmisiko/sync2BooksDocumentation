...
* [Upload receipts](./expenses-upload-receipts.md) - Attach files to synced transactions
* [Configure customer](./expenses-configure-customer.md) - Set up companies and connections
