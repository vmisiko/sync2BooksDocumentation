---
title: "QuickBooks Online FAQs"
description: "Answers to common questions about the QuickBooks Online integration."
---
...
Yes, setting company-level defaults reduces transaction complexity and ensures consistent categorization. See [Map transactions](/../expenses-map-transactions) for details.
...
- Check the [QuickBooks Online integration reference](/quickbooks-online-reference)
- Review [Sync transactions](/../expenses-sync-transactions) for sync troubleshooting
...
* [Set up the QuickBooks Online integration](/quickbooks-online-setup) - Configuration guide
