...
1. [Configure expense mapping](../expenses-map-transactions.md) - Set up default accounts and tax rates
2. [Create your first expense](../expenses-create-transactions.md) - Sync an expense transaction
3. [Upload receipts](../expenses-upload-receipts.md) - Attach files to expenses
